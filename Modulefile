...
author 'adaptavist'
#license 'apache2'
summary 'Definer puppet module'
description 'The purpose of this module is to declare resources using hiera. This follows
...
realm of hiera.'
project_page 'https://github.com/Adaptavist/puppet-definer'
